...
public class ExperitestAppium {
	...
	public void appiumTest() throws Exception {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(openSearch)));
		WebElement element=driver.findElement(By.xpath((openSearch)));
		element.click();


		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(searchField)));
		element=driver.findElement(By.xpath((searchField)));
		element.clear();
		element.sendKeys("book");

		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(searchSubmit)));
